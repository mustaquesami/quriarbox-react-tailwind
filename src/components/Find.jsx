...
const Find = () => {
  return (
    <section>
        ...
        <Container>
            <Flex className=' gap-6 mt-[85px] mb-[30px] flex-col lg:flex-row'>
        ...
        <button className='w-full flex mb-2 py-3 px-3 bg-[#F95C19] text-white rounded font-ox text-xl font-bold lg:w-[560px] lg:m-auto lg:block lg:mb-[150px]'><FaPhoneAlt className='inline-block mr-2' />Call us to delivery  123-456789</button>
    </section>
  )
}
