...
const Contact = () => {
  return (
    <section className='mb-[80px]'>
        <Container>
            <Flex className='w-full m-auto flex-col'>
                <div className='w-full'>
                    <Img src={contact}/>
                    <h4 className='font-ox text-[#F95C19] text-xl font-bold'>REQUEST A CALLBACK</h4>
                    <h2 className='font-raleway text-[#222132] text-base font-extrabold'>We will contact in the shortest time.</h2>
                    <h5 className='font-raleway text-[#9291A1] text-xl font-semibold'>Monday to Friday, 9am-5pm.</h5>
                </div>
